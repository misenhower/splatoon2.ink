...
test('list filters by prefix, sorts, and paginates with cursors', async () => {
  ...
  for (const key of [
    'assets/images/stage/b.png',
    'assets/images/stage/a.png',
    'assets/images/stage/deep/c.png',
    'assets/images/weapon/w.png',
    'data/x.json',
  ])
  ...
  assert.deepEqual(
    all.objects.map(o => o.key),
    ['assets/images/stage/a.png', 'assets/images/stage/b.png', 'assets/images/stage/deep/c.png'],
  );
